...
- [docs/AI_HANDOFF.md](docs/AI_HANDOFF.md) registra o estado operacional da tarefa atual. Atualize-o antes de transferir trabalho entre Codex e Claude ou ao encerrar uma sessão com trabalho incompleto.
