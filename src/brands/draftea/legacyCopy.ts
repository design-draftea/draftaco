export const exactDrafteaTranslations: Record<string, string> = {
  ...
  'APOSTAS': 'APUESTAS',
  'Apostas': 'Apuestas',
  'Apostas Ao Vivo': 'Apuestas en vivo',
  ...
  'CASSINO': 'CASINO',
  'Cassino': 'Casino',
  'Cassino Ao Vivo': 'Casino en vivo',
  'Cassino ao vivo': 'Casino en vivo',
  ...
  'Ofertas': 'Ofertas',
  'Partidas': 'Partidos',
  'PARTIDAS AO VIVO': 'PARTIDOS EN VIVO',
...
export const drafteaReplacements: [RegExp, string][] = [
  ...
  [/Apostas Ao Vivo/g, 'Apuestas en vivo'],
  [/Apostas/g, 'Apuestas'],
  [/APOSTAS/g, 'APUESTAS'],
  [/Desativar/g, 'Desactivar'],
  [/Ativar/g, 'Activar'],
  [/disponivel/g, 'disponibles'],
  [/Cassino Ao Vivo/g, 'Casino en vivo'],
  [/Cassino/g, 'Casino'],
  [/CASSINO/g, 'CASINO'],
  ...
  [/Ao vivo/g, 'En vivo'],
  [/AO VIVO/g, 'En vivo'],
  [/RESULTADO FINAL/g, 'Resultado final'],
  [/Futebol/g, 'Fútbol'],
  [/FUTEBOL/g, 'FÚTBOL'],
  [/Vencer/g, 'Gana'],
  [/Handcap/g, 'Hándicap'],
